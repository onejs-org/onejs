...
function allDependenciesOf(module, coll){
  ...
  module.dependencies.forEach(function(pack){
    if( ~ coll.indexOf(pack) ) return undefined;
...
function globalRequire(){
  return templates.globalRequire;
}
...
function render(module){
  ...
  return format(templates.wrapper, { entry: module.id, map: renderModules(module), require: renderRequire, globalRequire: options.global() ? globalRequire : '' });
}
